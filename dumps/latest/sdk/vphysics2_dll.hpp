...
namespace cs2::sdk::vphysics2 {
    ...
    class RnSoftbodySpring_t {
    public:
        SCHEMA_FIELD(uint16[2]                       , m_nParticle                                     , 0x0) // uint16[2]
    ...
    class RnSoftbodyCapsule_t {
    public:
        SCHEMA_FIELD(Vector[2]                       , m_vCenter                                       , 0x0) // Vector[2]
        SCHEMA_FIELD(float                           , m_flRadius                                      , 0x18) // float32
        SCHEMA_FIELD(uint16[2]                       , m_nParticle                                     , 0x1C) // uint16[2]
    };
    ...
    public:
        ...
        SCHEMA_FIELD(uint16[6]                       , nNode                                           , 0x8) // uint16[6]
    };
    ...
    class FeSimdRodConstraintAnim_t {
    public:
        SCHEMA_FIELD(uint16[4][2]                    , nNode                                           , 0x0) // uint16[4][2]
    ...
    class RnTriangle_t {
    public:
        SCHEMA_FIELD(int32[3]                        , m_nIndex                                        , 0x0) // int32[3]
    };
    ...
    public:
        ...
        SCHEMA_FIELD(Vector[3]                       , m_LocalInertiaInv                               , 0x48) // Vector[3]
    ...
    class OldFeEdge_t {
    public:
        SCHEMA_FIELD(float32[3]                      , m_flK                                           , 0x0) // float32[3]
        ...
        SCHEMA_FIELD(float32[4]                      , flAxialModelWeights                             , 0x30) // float32[4]
        SCHEMA_FIELD(uint16[4]                       , m_nNode                                         , 0x40) // uint16[4]
    };
    ...
    class FeTaperedCapsuleRigid_t {
    public:
        SCHEMA_FIELD(fltx4[2]                        , vSphere                                         , 0x0) // fltx4[2]
    ...
    class FeEdgeDesc_t {
    public:
        SCHEMA_FIELD(uint16[2]                       , nEdge                                           , 0x0) // uint16[2]
        SCHEMA_FIELD(uint16[2][2]                    , nSide                                           , 0x4) // uint16[2][2]
        SCHEMA_FIELD(uint16[2]                       , nVirtElem                                       , 0xC) // uint16[2]
    };
    ...
    public:
        ...
        SCHEMA_FIELD(uint16[2]                       , nNode                                           , 0x1C) // uint16[2]
    };
    ...
    class CGenericShapeProxy {
    public:
        SCHEMA_FIELD(CUtlLeanVectorFixedGrowable<Vector,8>, m_verts                                         , 0x30) // CUtlLeanVectorFixedGrowable<Vector,8>
    };
    ...
    class FeSimdQuad_t {
    public:
        SCHEMA_FIELD(uint16[4][4]                    , nNode                                           , 0x0) // uint16[4][4]
        SCHEMA_FIELD(fltx4                           , f4Slack                                         , 0x20) // fltx4
        SCHEMA_FIELD(FourVectors[4]                  , vShape                                          , 0x30) // FourVectors[4]
        SCHEMA_FIELD(fltx4[4]                        , f4Weights                                       , 0xF0) // fltx4[4]
    };
    ...
    class FeSimdNodeBase_t {
    public:
        SCHEMA_FIELD(uint16[4]                       , nNode                                           , 0x0) // uint16[4]
        SCHEMA_FIELD(uint16[4]                       , nNodeX0                                         , 0x8) // uint16[4]
        SCHEMA_FIELD(uint16[4]                       , nNodeX1                                         , 0x10) // uint16[4]
        SCHEMA_FIELD(uint16[4]                       , nNodeY0                                         , 0x18) // uint16[4]
        SCHEMA_FIELD(uint16[4]                       , nNodeY1                                         , 0x20) // uint16[4]
        SCHEMA_FIELD(uint16[4]                       , nDummy                                          , 0x28) // uint16[4]
    ...
    public:
        ...
        SCHEMA_FIELD(Vector4D[4]                     , vShape                                          , 0xC) // Vector4D[4]
    };
    ...
    class FeHingeLimit_t {
    public:
        SCHEMA_FIELD(uint16[6]                       , nNode                                           , 0x0) // uint16[6]
        SCHEMA_FIELD(std::uint32_t                   , nFlags                                          , 0xC) // uint32
    ...
    public:
        ...
        SCHEMA_FIELD(CUtlVector<CollisionDetailLayerInfo_t::Name_t>, m_vecSubtreeDetailLayers                        , 0x20) // CUtlVector<CollisionDetailLayerInfo_t::Name_t>
    ...
    class FeKelagerBend2_t {
    public:
        SCHEMA_FIELD(float32[3]                      , flWeight                                        , 0x0) // float32[3]
        SCHEMA_FIELD(float                           , flHeight0                                       , 0xC) // float32
        SCHEMA_FIELD(uint16[3]                       , nNode                                           , 0x10) // uint16[3]
    ...
    public:
        ...
        SCHEMA_FIELD(float32[3]                      , flMotionBias                                    , 0x8) // float32[3]
        SCHEMA_FIELD(uint16[3]                       , nNode                                           , 0x14) // uint16[3]
    };
    ...
    public:
        SCHEMA_FIELD(std::uint16_t                   , nNode                                           , 0x0) // uint16
        SCHEMA_FIELD(uint16[3]                       , nDummy                                          , 0x2) // uint16[3]
    ...
    class FeTri_t {
    public:
        SCHEMA_FIELD(uint16[3]                       , nNode                                           , 0x0) // uint16[3]
    ...
    public:
        ...
        SCHEMA_FIELD(uint32[4]                       , m_nEndIdx                                       , 0x28) // uint32[4]
    };
    ...
    class Dop26_t {
    public:
        SCHEMA_FIELD(float32[26]                     , m_flSupport                                     , 0x0) // float32[26]
    };
    ...
    public:
        ...
        SCHEMA_FIELD(float32[4]                      , flWeight                                        , 0xC) // float32[4]
        SCHEMA_FIELD(uint16[6]                       , nNode                                           , 0x1C) // uint16[6]
    };
    ...
    public:
        ...
        SCHEMA_FIELD(float32[2]                      , bodyMassScale                                   , 0xC) // float32[2]
    ...
    class FeTreeChildren_t {
    public:
        SCHEMA_FIELD(uint16[2]                       , nChild                                          , 0x0) // uint16[2]
    };
    ...
    class FeSimdTri_t {
    public:
        SCHEMA_FIELD(uint32[4][3]                    , nNode                                           , 0x0) // uint32[4][3]
