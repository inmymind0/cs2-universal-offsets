...
pub static CS2_SIGNATURES: &[Signature] = &[
    ...
    // ---------- RECOVERED prior batches lost in upstream reorg (2026-05-17) ----------
    // 77 entries from commit 81abd87 (CounterStrikeSharp, CS2Fixes, swiftly, Osiris,
    // cspatterns.dev verified block, etc.) that were dropped when upstream
    // restructured the file. Skipped 3 known renames already present.
    Signature { name: "FrameStageNotify",        module: "client.dll",  needle: "48 89 5C 24 ? 48 89 6C 24 ? 57 48 83 EC ? 48 8B F9 33 ED", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UnknownParticleFunction", module: "client.dll",  needle: "40 56 48 83 EC ? 41 8B F0",                                  resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "InitTraceData",           module: "client.dll",  needle: "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8D 79 ? 33 F6 C7 47", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CreateTrace",             module: "client.dll",  needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 41 56 41 57 48 83 EC ? ? ? ? ? 4D 8D 71", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "SetupMapInfo",            module: "client.dll",  needle: "48 8B C4 48 89 58 ? 48 89 68 ? 48 89 70 ? 57 48 81 EC ? ? ? ? 0F 29 70 ? 48 8B EA 0F 29 78 ? 45 33 C0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "MatchFoundHandler",       module: "client.dll",  needle: "48 85 D2 0F 84 ? ? ? ? 48 8B C4 55 53 56 57 48 8D A8", resolve: NONE, extra_off: 0, prototype: "void __fastcall MatchFoundHandler(__int64 thisptr, __int64 *kv)" },
    Signature { name: "Engine_IsConnected",      module: "engine2.dll", needle: "48 8B 05 ? ? ? ? 48 85 C0 74 ? 83 B8 ? ? ? ? ? 0F 9D C0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "Engine_GetLevelName",     module: "engine2.dll", needle: "48 83 EC ? E8 ? ? ? ? 84 C0 74 ? 48 8D 05 ? ? ? ? 48 83 C4 ? C3 48 8B 0D ? ? ? ? 48 85 C9 74 ? 83 B9 ? ? ? ? ? 7C ? 48 8B 89 ? ? ? ? 48 8D 05 ? ? ? ? 48 85 C9 48 0F 45 C1 48 83 C4 ? C3 48 8D 05 ? ? ? ? 48 83 C4 ? C3 ? ? ? ? ? ? ? ? ? ? ? ? 48 83 EC", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "Engine_GetLevelNameShort",module: "engine2.dll", needle: "48 83 EC ? E8 ? ? ? ? 84 C0 74 ? 48 8D 05 ? ? ? ? 48 83 C4 ? C3 48 8B 0D ? ? ? ? 48 85 C9 74 ? 83 B9 ? ? ? ? ? 7C ? 48 8B 89 ? ? ? ? 48 8D 05 ? ? ? ? 48 85 C9 48 0F 45 C1 48 83 C4 ? C3 48 8D 05 ? ? ? ? 48 83 C4 ? C3 ? ? ? ? ? ? ? ? ? ? ? ? B8", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UTIL_SayTextFilter", module: "server.dll", needle: "48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 49 8B F8", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UTIL_SayText2Filter", module: "server.dll", needle: "48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 41 56 41 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 45 0F B6 F0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "IsHearingClient", module: "engine2.dll", needle: "40 53 48 83 EC ? 48 8B D9 3B 51", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "TriggerPush_Touch", module: "server.dll", needle: "40 55 53 57 48 8D 6C 24 ? 48 81 EC ? ? ? ? 48 8B 02 48 8B F9", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "SetGroundEntity", module: "server.dll", needle: "48 89 5C 24 ? 55 56 57 41 55 41 57 48 83 EC ? 44 8B 89", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSPlayerController_SwitchTeam", module: "server.dll", needle: "40 53 57 48 81 EC ? ? ? ? 48 8B D9 8B FA", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UTIL_Remove", module: "server.dll", needle: "48 85 C9 74 ? 48 8B D1 48 8B 0D ? ? ? ?", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CEntitySystem_AddEntityIOEvent", module: "server.dll", needle: "48 89 5C 24 18 4C 89 4C 24 20 48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 83 EC 20", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CEntityInstance_AcceptInput", module: "server.dll", needle: "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 49 8B F0 48 8B D9 48 8B 0D", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CEntityIdentity_AcceptInput", module: "server.dll", needle: "48 89 5C 24 ? 48 89 54 24 ? 48 89 4C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 ? ? ? ? 48 81 EC ? ? ? ? 48 8B 02", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CEntityIOOutput_FireOutputInternal", module: "server.dll", needle: "4C 89 4C 24 ? 48 89 4C 24 ? 53 56", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGameEntitySystem_FindEntityByClassName", module: "server.dll", needle: "48 83 EC 68 45 33 C9", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGameEntitySystem_FindEntityByName", module: "server.dll", needle: "48 81 EC 88 ? ? ? 4D 85 C0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseEntity_SetGravityScale", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? F3 0F 10 81 ? ? ? ? 48 8B F9 0F 29 74 24 ? 0F 28 F1 0F 2E C6 7A ? 74", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "IGameSystem_InitAllSystems_pFirst", module: "server.dll", needle: "48 8B 1D ? ? ? ? 48 85 DB 0F 84 ? ? ? ? BD", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "IGameSystem_LoopPostInitAllSystems_pEventDispatcher", module: "server.dll", needle: "48 39 1D ? ? ? ? 74 ? 39 05", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "IGameSystem_LoopDestroyAllSystems_s_GameSystems", module: "server.dll", needle: "8B 05 ? ? ? ? 83 E8 ? 48 63 F8 0F 88", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBasePlayerController_SetPawn", module: "server.dll", needle: "44 88 4C 24 ? 53 57 41 54 41 56 41 57 48 83 EC", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGameRules_TerminateRound", module: "server.dll", needle: "48 8B C4 4C 89 48 ? 48 89 48 ? 55 56 41 56", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSPlayer_WeaponServices_EquipWeapon", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? 48 83 79 ? ? 48 8B FA 48 8B D9 75 ? E8 ? ? ? ? 48 8B 53", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CreateEntityByName", module: "server.dll", needle: "48 83 EC 48 C6 44 24 30 00", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CEntityIdentity_SetEntityName", module: "server.dll", needle: "48 89 5C 24 10 57 48 83 EC 20 48 8B D9 4C 8B C2", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "BotNavIgnore", module: "server.dll", needle: "0F 84 ? ? ? ? 80 B8 ? ? ? ? 00 0F 84 ? ? ? ? 80 3D ? ? ? ? 00 74 15", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseEntity_EmitSoundParams", module: "server.dll", needle: "48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 55 48 8B EC 48 81 EC ? ? ? ? 33 C0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "DispatchParticleEffect", module: "server.dll", needle: "48 89 5C 24 08 48 89 74 24 10 48 89 7C 24 18 4C 89 74 24 20 55 48 8D 6C 24 D1", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseEntity_EmitSoundFilter", module: "server.dll", needle: "40 53 48 83 EC ? 4C 89 4C 24 ? 48 8B D9 45 8B C8", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseEntity_SetMoveType", module: "server.dll", needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC ? 41 0F B6 F0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CPhysBox_Use", module: "server.dll", needle: "4C 8B 43 ? 48 8D 8F ? ? ? ? 48 8B 13 E8 ? ? ? ? 48 8B 5C 24 ? 48 83 C4 ? 5F C3 CC CC CC CC 48 89 5C 24", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CTakeDamageInfo", module: "server.dll", needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 83 EC ? 45 33 F6 48 C7 41", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "ProcessUsercmds", module: "server.dll", needle: "48 8B C4 44 88 48 20 44 89 40 18 48 89 50 10 53", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGamePlayerEquip_InputTriggerForAllPlayers", module: "server.dll", needle: "40 55 53 41 54 41 56 48 8B EC 48 83 EC ? 4C 8B F1", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGamePlayerEquip_InputTriggerForActivatedPlayer", module: "server.dll", needle: "48 89 5C 24 18 56 48 83 EC 20 48 8B 1A", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "GetFreeClient", module: "engine2.dll", needle: "48 89 54 24 ? 53 56 57 41 56 48 83 EC", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "FindUseEntity", module: "server.dll", needle: "4C 89 44 24 ? F3 0F 11 4C 24 ? 55 53 56", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "TraceFunc", module: "server.dll", needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 54 41 56 41 57 48 81 EC ? ? ? ? 45 33 E4", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBasePlayerPawn_GetEyeAngles", module: "server.dll", needle: "48 89 5C 24 ? 57 48 81 EC ? ? ? ? 48 8B F9 48 8B DA 48 8B 89 ? ? ? ? 48 85 C9", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseFilter_InputTestActivator", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? 4C 8B 02", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "GameSystem_Think_CheckSteamBan", module: "server.dll", needle: "41 54 48 81 EC ? ? ? ? BA ? ? ? ? 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 85 C0", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSGameRules__sm_mapGcBanInformation", module: "server.dll", needle: "48 8D 0D ? ? ? ? 48 89 45 ? 0F 11 45", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "GetSpawnGroups", module: "server.dll", needle: "40 56 48 83 EC ? 48 89 5C 24 ? 48 8D B1", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSPlayer_ItemServices_CanAcquire", module: "server.dll", needle: "44 89 44 24 ? 48 89 54 24 ? 48 89 4C 24 ? 55 53 56 57 41 55 41 56 41 57 48 8B EC", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CTriggerGravity_GravityTouch", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? 48 8B 02 48 8B F9 48 8B CA 48 8B DA FF 90 ? ? ? ? 84 C0 74 ? F3 0F 10 8F", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UTIL_ClientPrintAll", module: "server.dll", needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 8B E9 49 8B D9", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "ClientPrint", module: "server.dll", needle: "48 85 C9 0F 84 ? ? ? ? 48 89 5C 24 ? 55", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSPlayerPawnBase_PostThink", module: "server.dll", needle: "40 55 53 56 57 41 54 48 8D 6C 24 ? 48 81 EC ? ? ? ? 4C 89 AC 24", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CGameEventManager_Init", module: "server.dll", needle: "40 53 48 83 EC ? 48 8B 01 48 8B D9 FF 50 ? 48 8B 03", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "GiveNamedItem", module: "server.dll", needle: "48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 44 89 44 24", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseModelEntity_SetModel", module: "server.dll", needle: "40 53 48 83 EC ? 48 8B D9 4C 8B C2 48 8B 0D ? ? ? ? 48 8D 54 24 ? 48 8B 01 FF 50 ? 48 8B 54 24 ? 48 8B CB E8 ? ? ? ? 48 83 C4 ? 5B C3", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CCSPlayer_WeaponServices_CanUse", module: "server.dll", needle: "48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 41 54 41 55 41 56 41 57 48 83 EC ? 48 8B 01 48 8B FA", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "GetCSWeaponDataFromKey", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? 33 FF 4C 8B CA 8B D9", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "UTIL_CreateEntityByName", module: "server.dll", needle: "48 83 EC ? C6 44 24 ? ? 4C 8B C1", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseEntity_DispatchSpawn", module: "server.dll", needle: "48 89 5C 24 ? 57 48 83 EC ? 48 8B DA 48 8B F9 48 85 C9 0F 84 ? ? ? ? 48 85 D2", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "LegacyGameEventListener", module: "server.dll", needle: "48 8B 15 ? ? ? ? 48 85 D2 74 ? 83 F9 ? 77", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBasePlayerPawn_RemovePlayerItem", module: "server.dll", needle: "48 85 D2 0F 84 ? ? ? ? 48 89 5C 24 ? 57 48 83 EC ? 48 8B DA 48 8B F9 E8", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseTrigger_StartTouch", module: "server.dll", needle: "40 57 41 56 48 83 EC ? 48 8B 01", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CBaseTrigger_EndTouch", module: "server.dll", needle: "40 53 41 55 48 83 EC ? 83 BA", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CheckTransmit", module: "server.dll", needle: "48 8B C4 4C 89 48 ? 48 89 50 ? 48 89 48 ? 55 48 8D A8 ? ? ? ? 48 81 EC ? ? ? ? 48 89 58 ? 48 89 70", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "NetworkStateChanged", module: "server.dll", needle: "4C 8B C2 48 8B D1 48 8B 09", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "Host_Say", module: "server.dll", needle: "44 89 4C 24 ? 44 88 44 24", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "HostStateRequest", module: "engine2.dll", needle: "48 89 74 24 ? 57 48 83 EC ? 33 F6 48 8B FA 48 39 35", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "ReplyConnection", module: "engine2.dll", needle: "48 8B C4 55 41 55 41 56", resolve: NONE, extra_off: 0, prototype: "" },
    Signature { name: "CAttributeList_SetOrAddAttributeValueByName", module: "server.dll", needle: "40 53 55 41 56 48 81 EC 90 00 00 00", resolve: NONE, extra_off: 0, prototype: "" },
