...
namespace cs2::verified
{
    ...
    // ----- Seeded Triggerbot [working] -----
    namespace Seeded_Triggerbot
    {
        constexpr const char* status = "working";
    }

    // ----- Aimbot / Trigger Cooperation [working] -----
    namespace Aimbot___Trigger_Cooperation
    {
        constexpr const char* status = "working";
    }

    // ----- Kill Sound Override [working] -----
    namespace Kill_Sound_Override
    {
        constexpr const char* status = "working";
    }

    // ----- Skin Changer (paint kits) [working] -----
    namespace Skin_Changer__paint_kits_
    {
        constexpr const char* status = "working";
    }

    // ----- Knife Model Swap [working] -----
    namespace Knife_Model_Swap
    {
        constexpr const char* status = "working";
    }

    // ----- Glove Changer [broken] -----
    namespace Glove_Changer
    {
        constexpr const char* status = "broken";
    }

    // ----- Inventory Changer [broken] -----
    namespace Inventory_Changer
    {
        constexpr const char* status = "broken";
    }

    // ----- BHOP (Subtick) [working] -----
    namespace BHOP__Subtick_
    {
        constexpr const char* status = "working";
    }
