...
namespace pattern {
    ...
    namespace client {
        inline constexpr std::string_view ActionAbandonOngoingMatch = "40 57 48 83 EC 50 33 FF F6 05 B1 99 49 01 01 0F";
        ...
        inline constexpr std::string_view ActionReconnectToOngoingMatch = "48 83 EC 38 F6 05 55 8A 49 01 01 74 5F 48 8B 0D";
        ...
        inline constexpr std::string_view CAttributeStringInit = "48 8B C2 48 83 C8 02 45 84 C0 48 0F 44 C2 48 89 41 08 48 8D 05 6F CA 3C";
        ...
        inline constexpr std::string_view C_BaseEntity_StartParticleSystem = "48 89 5C 24 08 55 48 8B EC 48 83 EC 40 E8 2E 26";
        inline constexpr std::string_view C_CSWeaponBase_GetEconWpnData = "40 53 48 83 EC 40 48 8B D9 E8 ? ? ? ? 48 8B C8 E8 9A 4D";
        ...
        inline constexpr std::string_view ChangeModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D 65";
        ...
        inline constexpr std::string_view Constructor = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 30 48 8B F1 48 8B FA B9 50 00 00 00 E8 D1";
        ...
        inline constexpr std::string_view CreateEntityByClassName = "4C 8D 05 ? ? ? ? 4C 8B CF BA 03 00 00 00 FF 15 2D 09 30";
        inline constexpr std::string_view CreateInterface = "4C 8B 0D ? ? ? ? 4C 8B D2 4C 8B D9 4D 85 C9";
        inline constexpr std::string_view CreateNewSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 F2 0E";
        inline constexpr std::string_view CreateParticleEffect = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 50 F3 0F 10 1D 11";
        inline constexpr std::string_view CreateSOSubclassEconItem = "48 83 EC 28 B9 48 00 00 00 E8 ? ? ? ? 48 85";
        inline constexpr std::string_view CreateSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 F2 0E";
        ...
        inline constexpr std::string_view DrawSmokeArray = "40 55 41 54 41 55 48 8D AC 24 20 F9 FF FF 48 81";
        ...
        inline constexpr std::string_view FindHudElement = "48 8D 15 ? ? ? ? 45 33 C0 B9 01 00 00 00 FF 15 E3 F0 B4";
        ...
        inline constexpr std::string_view GameTraceLine = "4C 8B DC 49 89 5B 08 49 89 6B 10 49 89 73 18 57 41 56 41 57 48 81 EC B0";
        inline constexpr std::string_view GenerateDirectChallengeCode = "48 83 EC 28 E8 ? ? ? ? 48 8B 05 ? ? ? ?";
        inline constexpr std::string_view GetAbsOrigin = "40 53 48 83 EC 20 48 8B 99 30 03 00 00 90 80 BB 10 01 00 00 00 75 0C 48 8B CB E8 51";
        ...
        inline constexpr std::string_view GetBombsiteACenter = "48 89 5C 24 08 57 48 83 EC 20 48 8B F9 48 8B DA 48 8B 0D D1";
        inline constexpr std::string_view GetBombsiteBCenter = "48 89 5C 24 08 57 48 83 EC 20 48 8B F9 48 8B DA 48 8B 0D 71";
        ...
        inline constexpr std::string_view GetCooldownSecondsRemaining = "48 83 EC 58 8B 05 ? ? ? ? C1 E8 ? ? ? ? 52 48 8D 4C";
        inline constexpr std::string_view GetCooldownType = "8B 15 ? ? ? ? 8D 42 F8 83 F8 0C 77 14 4C 8D";
        inline constexpr std::string_view GetCustomPaintKitIndex = "48 89 5C 24 08 57 48 83 EC 40 8B 15 ? ? ? ? 48 8B F9 65 48 8B 04 25 58 00 00 00 B9 98 00 00 00 48 8B 04 D0 8B 04 01 39 05 B2 48 31 01 0F 8F";
        inline constexpr std::string_view GetDirectChallengeCode = "48 83 EC 28 F7 05 C2 46 1B 01 FF FF FF 3F 75 05";
        ...
        inline constexpr std::string_view GetLocalControllerById = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 08 03 00 00 8B 08 48 63 C1 4C 8D 05 76 CD";
        inline constexpr std::string_view GetLocalPawn = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 08 03 00 00 8B 08 48 63 C1 4C 8D 05 76 CD";
        inline constexpr std::string_view GetMapBspName = "48 8B 0D ? ? ? ? 48 8B 01 48 FF A0 00 02 00";
        inline constexpr std::string_view GetMapName = "48 83 EC 28 48 8B 0D ? ? ? ? 48 8B 01 FF 90 00 02 00 00";
        ...
        inline constexpr std::string_view GetPlayerModel = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B CA FF 15 88 BD A2 00";
        ...
        inline constexpr std::string_view GetRemovedAimpunch = "F2 0F 10 44 24 60 F2 0F 11 84 24 88 00 00 00 FF 15 14 4C 80";
        inline constexpr std::string_view GetRotatingOfficialMapGroupCurrentState = "48 81 EC 38 04 00 00 48 8B CA 48 8D 15 C7 50 B1";
        inline constexpr std::string_view GetServerName = "40 53 48 83 EC 20 48 8B D9 48 8B 0D ? ? ? ? 48 85 C9 74 35 E8 B6 4F";
        ...
        inline constexpr std::string_view GetTournamentStageNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 8B 25 46";
        ...
        inline constexpr std::string_view GetTournamentTeamNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 2B 22 46";
        ...
        inline constexpr std::string_view GetTraceInfo_v2 = "48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 48 83 EC 60 48 8B E9 0F";
        inline constexpr std::string_view GetTransformsForHitboxList = "48 89 5C 24 18 55 56 57 41 55 41 57 48 81 EC A0";
        inline constexpr std::string_view GetUserCmdManager = "41 56 41 57 48 83 EC 48 48 8D 54 24 68 E8 9E A4";
        ...
        inline constexpr std::string_view HandleBulletPenetration_v2 = "48 8B C4 44 89 48 20 48 89 50 10 48 89 48 08 55 57 41 57 48";
        ...
        inline constexpr std::string_view HasOngoingMatch = "0F B6 05 E9 ? ? ? ? 01 C3 CC CC CC CC CC CC";
        ...
        inline constexpr std::string_view InfoForResourceTypeCCompositeMaterial_TypeManager = "40 55 41 56 48 83 EC 68 48 8B EA 83 F9 06 0F 87 ? ? ? ? 48 63 C1 48 8D 15 22 3D";
        ...
        inline constexpr std::string_view InitTraceInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D EF 02 EF";
        ...
        inline constexpr std::string_view IsLocalPlayerWatchingOwnDemo = "48 89 5C 24 08 48 89 6C 24 18 56 57 41 56 48 83 EC 20 48 8B 0D 4F 5A 43";
        ...
        inline constexpr std::string_view LevelShutdown = "48 83 EC 28 48 8B 0D ? ? ? ? 48 8D 15 1E 12";
        ...
        inline constexpr std::string_view MarkInterpLatchFlagsDirty = "40 53 56 57 48 83 EC 40 80 3D F5 E4 11 02 00 8B";
        ...
        inline constexpr std::string_view ParticleCollection = "48 89 5C 24 08 57 48 83 EC 20 0F 28 05 2F 8B 2F";
        ...
        inline constexpr std::string_view PostProcessQuery = "48 89 5C 24 08 66 41 0F 6E C8 48 8D 1D CF 5A F6";
        ...
        inline constexpr std::string_view QueueForceSubtickMove = "48 83 EC 28 8B 0D ? ? ? ? 65 48 8B 04 25 58 00 00 00 BA 98 00 00 00 48 8B 04 C8 8B 04 02 39 05 EB 45 96 01 0F 8F F4";
        ...
        inline constexpr std::string_view SetDynamicAttributeValue = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 03 13 01";
        inline constexpr std::string_view SetDynamicAttributeValue_raw = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 03 13 01";
        ...
        inline constexpr std::string_view SetModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D 65";
        inline constexpr std::string_view SetPlayerReady = "40 53 48 83 EC 20 48 8B DA 48 8D 15 ? ? ? ? 48 8B CB FF";
        inline constexpr std::string_view SetSceneObjectAttributeFloat4 = "E9 ? ? ? ? 48 89 74 24 18 57 48 83 EC 20 66";
        ...
        inline constexpr std::string_view ShouldShowHudElements = "48 83 EC 28 BA FF FF FF FF 48 8D 0D ? ? ? ? E8 8B EF 8F";
        ...
        inline constexpr std::string_view ThinkReturn = "BA 04 00 00 00 FF 15 96 BC 5F 01 84 C0 0F 84 C2";
        ...
        inline constexpr std::string_view TraceInitInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D EF 02 EF";
        ...
        inline constexpr std::string_view UntrustedFlagSetter = "74 26 C6 05 3A 99 05 02 01 33 C0 83 F8 01 74 18";
        ...
        inline constexpr std::string_view UpdateSkybox = "48 89 5C 24 08 57 48 83 EC 30 48 8B F9 E8 FE 15";
        ...
        inline constexpr std::string_view ViewModelHideZoomed = "48 89 5C 24 20 55 56 57 41 54 41 56 48 8B EC 48 83 EC 50 48 8D 05 46 34";
        ...
        inline constexpr std::string_view pPlantedC4s = "0F ? ? ? ? ? 39 ? ? ? ? ? 7E ? 48 8B 0D";
    ...
    namespace engine2 {
        ...
        inline constexpr std::string_view InternalProcessPacketEntities = "40 55 56 57 41 56 41 57 48 8D AC 24 40 FF FF FF";
        ...
        inline constexpr std::string_view SendMovePacket = "40 55 57 41 55 48 8D AC 24 90 E0 FF FF B8 70 20";
    ...
    namespace server {
        inline constexpr std::string_view AcceptInput = "48 89 5C 24 18 48 89 54 24 10 48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 8D AC 24 70 FF";
        ...
        inline constexpr std::string_view CCSGameRules_sm_mapGcBanInformation = "48 8D 0D ? ? ? ? 48 89 45 F7 0F 11 45 37 0F";
    ...
    namespace soundsystem {
        ...
        inline constexpr std::string_view pSoundSystem = "48 8D 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 89 15";
    }
    namespace tier0 {
        inline constexpr std::string_view CreateInterface = "4C 8B 0D ? ? ? ? 4C 8B D2 4C 8B D9 4D 85 C9";
